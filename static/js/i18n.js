...
const TRANSLATIONS = {
  en: {
    ...
    "recipes.importPhotos": "Import from Photos",
    "recipes.takePhotos": "Take Photos",
    "recipes.chooseFromLibrary": "Choose from Library",
    "recipes.cameraError": "Couldn't open the camera. Check browser permissions.",
    "recipes.processingPhotos": "Reading recipe from photo(s)… This may take a moment.",
  ...
  fr: {
    ...
    "recipes.importPhotos": "Importer depuis des photos",
    "recipes.takePhotos": "Prendre des photos",
    "recipes.chooseFromLibrary": "Choisir dans la bibliothèque",
    "recipes.cameraError": "Impossible d'accéder à la caméra. Vérifiez les autorisations du navigateur.",
    "recipes.processingPhotos": "Lecture de la recette à partir des photos… Cela peut prendre un moment.",
